...
const Toaster = () => {
  ...
  const [toasts, setToasts] = useState([
    { position: 'static', autohide: false, closeButton: false, fade: false},
    { position: 'static', autohide: false, closeButton: false, fade: false},
    { position: 'top-right', autohide: true, closeButton: false, fade: false }
  ])
  ...
  const addToast = () => {
    setToasts([
      ...toasts, 
      { position, autohide: (autohide && autohideValue !== 0), closeButton, fade }
    ])
  }
              ...
              <CForm>
                ...
                <CFormGroup variant="custom-checkbox" className="my-2 mt-4">
                  <CInputCheckbox
                    id="autohide"
                    checked={autohide}
                    onChange={(e: any) => { setAutohide(e.target.checked) }}
                    custom
                  />
                ...
                <CFormGroup variant="custom-checkbox" className="my-2">
                  <CInputCheckbox
                    id="fade"
                    checked={fade}
                    onChange={(e: any) => { setFade(e.target.checked) }}
                    custom
                  />
                ...
                <CFormGroup variant="custom-checkbox" className="my-2">
                  <CInputCheckbox
                    ...
                    custom
                    checked={closeButton}
                    onChange={(e: any) => { setCloseButton(e.target.checked) }}
                  />
